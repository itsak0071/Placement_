...
/*--------------------------------------------------------------------------------------------------------------------------*/
 ...
 // Credits to HealthyUG for the inspiration.
  ...
  struct SegTree {
  	vector<Node> tree;
  	string arr; // type may change
  	int n;
  	int s;
  	SegTree(int a_len, string &a) { // change if type updated
  		arr = a;
  		n = a_len;
  		s = 1;
  		while(s < 2 * n){
  	...
  	void make_update(int index, char val) {  // pass in as many parameters as required
  ...
  struct Node1 {
  	 vector<int>v; // may change
  	Node1() { // Identity element
  		  v.assign(26,0);	;// may change
  	}
  	Node1(char p1) {  // Actual Node
  		v.assign(26,0);
  		v[p1-'a']=1; // may change
  	}
  ...
  struct Update1 {
  	  char ch; // may change
  	Update1(char p1) { // Actual Update
  		ch = p1; // may change
  	}
  	void apply(Node1 &a) { // apply update to given node
  		a.v.assign(26,0);
  		a.v[ch-'a']=1; // may change
  	}
  };
  void solve(){
