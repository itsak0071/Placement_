...
struct Update1 {
	...
	Update1(ll p1) { // Actual Update
		val = p1; // may change   here you want to make update a[i]=p1;
	}
	void apply(Node1 &a) { // apply update to given node
		a.val = val; // may change  // idhar aik hi variabel  node me val thae=ts why yha pr ik hi update kiya gya h  thats why   
	}
};
void solve(){
    int n; cin>>n  ;
